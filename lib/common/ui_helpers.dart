...
Widget spacedDivider = const Column(
  children: <Widget>[
    verticalSpaceTiny,
    Divider(color: ColorsApp.borderColor, height: 5.0, endIndent: 15, indent: 15),
    verticalSpaceTiny
  ],
);
Widget spacedDividerWhite = const Column(
  children: <Widget>[
    verticalSpaceTiny,
    Divider(color: Colors.white, height: 5.0, endIndent: 15, indent: 15),
    verticalSpaceTiny
  ],
);
